...
// Single-item create WITH optional image — used by front/product.vue
...
// Bulk create — no images, used by admin/AddProductBranches.vue
...
// Update — image is optional; only replaced if a new file is sent
