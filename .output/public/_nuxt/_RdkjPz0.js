...
`),t=(...v)=>o.push(...v);return t(27,64),t(27,97,1),t(27,69,1),c("TEST PRINT"),t(27,69,0),c(P.value?.name??"Printer"),c(new Date().toLocaleString("en-PH")),c("If you can read this,"),c("your printer is ready."),c("Thank you for choosing Budget POS."),c(),t(27,100,3),t(29,86,65,3),new Uint8Array(o)}async function x(e){const{BluetoothSerial:s}=await E(async()=>{const{BluetoothSerial:r}=await import("./BqPI0Rop.js");return{BluetoothSerial:r}},[],import.meta.url),o=128;for(let r=0;r<e.length;r+=o)await s.write(e.slice(r,r+o)),await new Promise(c=>setTimeout(c,30))}async function J(){if(!u()||!p.value)return alert("Connect a printer first."),!1;C.value=!0;try{return await x(q()),!0}catch(e){return w.value=e?.message??"Test print failed",alert(`Test print failed: ${w.value}`),p.value=!1,!1}finally{C.value=!1}}function B(e,s,o,r){const c=r??S.value;try{const t=document.createElement("iframe");Object.assign(t.style,{position:"fixed",width:"0",height:"0",border:"none"}),document.body.appendChild(t);const v=t.contentWindow.document,f=i=>`₱${Number(i).toFixed(2)}`,y=new Date(e.created_at),b=e.payment_method==="gcash"?"GCash":"Cash",n=e.order_type==="take-out"?"Order Type: Take out":"Order Type: Dine In",a=o!=="sarisari",T=z(o),d=c?`
